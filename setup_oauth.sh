...
echo "     • https://golf-tip.org"
echo "     • https://www.golf-tip.org"
echo "     • https://golf-tip-app.fly.dev"
echo "     • http://localhost:3000"
echo "   - Authorized redirect URIs:"
echo "     • https://golf-tip.org/auth/google_oauth2/callback"
echo "     • https://www.golf-tip.org/auth/google_oauth2/callback"
